...
class SongPlayer extends React.PureComponent {
  constructor(props) {
    super(props)
    this.audio = {}
  }
  ...
  playModeShowTime = () => {
    this.updateParams({
      playModeShowTime: 1000 //createRandomNum(200, 2000),
    })
  }
  changePlayIndex = () => {
    this.updateParams({
      playIndex: 0 //createRandomNum(0, this.state.params.audioLists.length - 1),
    })
  }
  updateParams = (params) => {
    const data = {
